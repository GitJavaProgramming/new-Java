package org.pp.java8.stream.exercise.java8functional;

import org.junit.BeforeClass;
import org.junit.Test;
import org.pp.java8.stream.exercise.java8functional.model.Artist;
...
public class FunctionalTest {
    ...
    public void streamOpsTest() {
         ...
         *      * * combiner.apply(u, accumulator.apply(identity, t)) == accumulator.apply(u, t)
         *
         *      参看    org.pp.java8.stream.exercise.StreamTest
         *              org.pp.java8.stream.demo.ParallelStreamDemo
         */
